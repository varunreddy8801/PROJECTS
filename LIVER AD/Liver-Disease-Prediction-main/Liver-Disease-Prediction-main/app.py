...
def predict():
    if request.method == 'POST':
        ...
        Alkaline_Phosphotase = int(float(request.form['Alkaline_Phosphotase']))
        Alamine_Aminotransferase = int(float(request.form['Alamine_Aminotransferase']))
        Aspartate_Aminotransferase = int(float(request.form['Aspartate_Aminotransferase']))
